...
// מרווח תוכן מתחת לבאנר הקבוע – מודד גובה header בפועל
...
function initQuiz() {
    ...
    submitBtn.addEventListener('click', () => {
        ...
        // Set message based on score (by html lang)
        let message = '';
        let emoji = '';
        const lang = (document.documentElement.lang || 'he').toLowerCase().slice(0, 2);
        const quizMessages = {
            he: {
                excellent: 'מצוין! שליטה מרשימה בחומר!',
                good: 'כל הכבוד! הבנה טובה של הנושא',
                ok: 'לא רע! כדאי לחזור על החומר',
                low: 'מומלץ לקרוא שוב את המאמר'
            },
            en: {
                excellent: 'Excellent! Impressive mastery!',
                good: 'Well done! Good understanding of the topic',
                ok: 'Not bad! Worth reviewing the material',
                low: 'Recommended to read the lesson again'
            },
            ar: {
                excellent: 'ممتاز! إتقان رائع للمادة!',
                good: 'أحسنت! فهم جيد للموضوع',
                ok: 'لا بأس! يُفضّل مراجعة المادة',
                low: 'يُنصح بقراءة الدرس مرة أخرى'
            },
            hi: {
                excellent: 'उत्कृष्ट! विषय पर शानदार पकड़!',
